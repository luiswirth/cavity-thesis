...
typically inaccurate outside the regime they were trained on#hl[ #cite(<raissi>, supplement: [Sec. 1])]. The more principled
...
a full posterior distribution instead of just a point estimate#hl[ #cite(<rasmussen>, supplement: [Ch. 2])]. This enables
...
BEM library *`Bembel`*#hl[ #cite(<bembel>)]. The two solvers share only the problem setup and nothing
