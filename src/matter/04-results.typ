...
The figure matches physical expectations. The scattered wavefronts are concentric and the LIC texture forms smooth rings, and the spherical symmetry of the cavity is clearly visible. #hl[The total field is a pure standing wave. The time-averaged Poynting vector $avec(S) = 1/2 Re(Ev times conj(Hv))$ confirms it: for the total field $avec(S)$ vanishes throughout the cavity, while the incident dipole field alone carries a nonzero outward energy flux. The incident field's energy flow is thus cancelled exactly, as required in a lossless cavity at a non-resonant frequency, where no net power can be radiated through the perfectly conducting wall or absorbed in the interior and the steady-state field is purely reactive.]
