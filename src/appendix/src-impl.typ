...
Each repository carries a README documenting its purpose, setup, and usage, so the code remains the single source of truth and this thesis does not restate implementation details.
...
The general Maxwell-constrained EPGP library: plane-wave feature maps, the GP regression core, and tangential-trace conditioning.
...
A thin cavity-specific layer over `maxwellgp`, owning the analytic dipole physics and the reaction-operator assembly.
